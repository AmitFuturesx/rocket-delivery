  ...
  var ZONE_RATES = [
    ...
    },
    {
      from: ['ראשון לציון', 'תל אביב', 'פתח תקווה', 'חולון', 'בת ים',
             'באר יעקב', 'נס ציונה'],
      to:   ['באר שבע', 'רהט', 'עומר', 'נבטים', 'אופקים'],
    ...
    {
      /* אופקים belongs here in his message too, but he already priced it at
         370 in the Beer Sheva block above. Until he says which is right it is
         left out, so its price does not change by accident. */
      from: ['תל אביב', 'חולון', 'ראשון לציון', 'נס ציונה', 'רחובות', 'הרצליה',
             'רמת השרון', 'פתח תקווה', 'בני ברק', 'רמת גן', 'גבעתיים',
             'באר יעקב', 'יהוד', 'סביון', 'אור יהודה', 'גנות', 'בית דגן',
             'צריפין', 'לוד', 'רמלה', 'פלמחים'],
      to:   ['בארי', 'נתיבות', 'כפר עזה', 'נחל עוז', 'רעים', 'תקומה',
             'מלילות', 'גבעולים', 'תדהר', 'פטיש', 'רנן', 'משמר הנגב',
             'בית קמה', 'שובל', 'דביר'],
